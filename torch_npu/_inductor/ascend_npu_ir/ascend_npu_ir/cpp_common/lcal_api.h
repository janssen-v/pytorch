...
int LcclSend(void *buff, int64_t count, HcclDataType dataType, int destRank, LcalCommPtr comm, aclrtStream stream);

int LcclRecv(void *buff, int64_t count, HcclDataType dataType, int srcRank, LcalCommPtr comm, aclrtStream stream);
